...
export const MOCK_CONTRACTS: InvestmentContract[] = [
  {
    ...
    durationMonths: 24,
    operationPct: 30,
    // 30,000 office + 40,000 investor = 70,000 total agreed profit.
    // Round numbers chosen to make the policy math easy to follow in demos.
    officeExpectedProfit: 30_000,
    investorExpectedProfit: 40_000,
    utilized: 10_000,
    remaining: 90_000,
    status: "active",
    profitNotes: "ربح المكتب 30,000 وربح المستثمر 40,000 من ربح إجمالي قدره 70,000.",
    ...
    timeline: [
      ...
      { ts: "2024-03-20", text: "صرف 10,000 ر.س لعقد تقسيط" },
    ],
  ...
  },
  {
    ...
    durationMonths: 24,
    operationPct: 0,
    // Internal investor — office is both funder and operator. All
    // profit flows to the internal investor account.
    officeExpectedProfit: 0,
    investorExpectedProfit: 500_000,
    utilized: 2_000_000,
    remaining: 500_000,
    status: "active",
  ...
  },
  {
    ...
    durationMonths: 18,
    operationPct: 14,
    officeExpectedProfit: 210_000,
    investorExpectedProfit: 273_000,
    utilized: 1_200_000,
    remaining: 300_000,
    status: "active",
  ...
  },
  {
    ...
    durationMonths: 36,
    operationPct: 16,
    officeExpectedProfit: 240_000,
    investorExpectedProfit: 312_000,
    utilized: 1_000_000,
    remaining: 500_000,
    status: "active",
  ...
  },
  {
    ...
    durationMonths: 12,
    operationPct: 12,
    officeExpectedProfit: 96_000,
    investorExpectedProfit: 124_800,
    utilized: 500_000,
    remaining: 300_000,
    status: "active",
  ...
  },
  {
    ...
    durationMonths: 24,
    operationPct: 14,
    officeExpectedProfit: 168_000,
    investorExpectedProfit: 218_400,
    utilized: 900_000,
    remaining: 300_000,
    status: "active",
  ...
  },
  {
    ...
    durationMonths: 12,
    operationPct: 13,
    officeExpectedProfit: 130_000,
    investorExpectedProfit: 169_000,
    utilized: 700_000,
    remaining: 300_000,
    status: "active",
  ...
  },
  {
    ...
    durationMonths: 24,
    operationPct: 15,
    officeExpectedProfit: 150_000,
    investorExpectedProfit: 195_000,
    utilized: 600_000,
    remaining: 400_000,
    status: "active",
  ...
  },
  {
    ...
    durationMonths: 18,
    operationPct: 14,
    officeExpectedProfit: 84_000,
    investorExpectedProfit: 109_200,
    utilized: 400_000,
    remaining: 200_000,
    status: "active",
  ...
  },
  {
    ...
    operationPct: 0,
    officeExpectedProfit: 0,
    investorExpectedProfit: 240_000,
    utilized: 1_500_000,
    remaining: 100_000,
    status: "active",
    profitNotes: "حساب داخلي للمكتب — كل الأرباح للمكتب.",
  ...
  },
  {
    ...
    durationMonths: 12,
    operationPct: 13,
    officeExpectedProfit: 65_000,
    investorExpectedProfit: 84_500,
    utilized: 0,
    remaining: 500_000,
    status: "pendingSetup",
  ...
  // The source reference is stored for internal tracking but not surfaced in UI.
  {
    ...
    durationMonths: 12,
    operationPct: 10,
    officeExpectedProfit: 1_350,
    investorExpectedProfit: 1_755,
    utilized: 0,
    remaining: 13_500,
    status: "active",
